...
public class MbrCmpLetterDates extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MbrCmpLetterDates frame = new MbrCmpLetterDates();
	...
	public MbrCmpLetterDates() {
	}

	public MbrCmpLetterDates(DatabaseVariables dbVar, EquityAssetType[] aryEquityAssetType) {
					...
					if (dbVar.getGoodToGo()) {
						try {
							Desktop.getDesktop().open(new File(
									"K:\\Member Company\\Member Company Excel Reports\\Member_Company_Equity_List.xlsm"));
							// "K:\\Jarvis\\Member Company Conversion\\Member Company Excel
							// Reports\\Member_Company_Equity_List.xlsm"));
